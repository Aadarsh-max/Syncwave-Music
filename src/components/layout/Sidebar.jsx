  ...
  return (
    <>
      <aside
        ...
        style={{
          background:
            "linear-gradient(180deg, #080810 0%, #0a0a14 60%, #06060f 100%)",
      ...
      >
        ...
        >
          ...
          <span
            ...
            style={{
              background:
                "linear-gradient(135deg, #fff 0%, #1DB954 50%, #0ea5e9 100%)",
        ...
        <div className="px-3 mt-3">
          ...
          <div className="flex flex-col gap-0.5">
            ...
            >
              <HiUserGroup size={20} style={{ flexShrink: 0 }} />
              Create Room
            </button>
            <button
            ...
            >
              <HiSparkles size={20} style={{ flexShrink: 0 }} />
              Join Room
            </button>
            <NavLink
              to="/grow"
