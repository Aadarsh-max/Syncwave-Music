        ...
        {Object.entries(moodConfig).map(([key, config]) => {
          ...
          return (
            <button
              ...
              disabled={loading}
              className="flex flex-col items-center gap-1.5 p-2 md:p-3 rounded-2xl cursor-pointer transition-all duration-200 hover:scale-[1.04] active:scale-[0.97]"
              style={{
                ...
                boxShadow: isSelected
                  ? `0 0 24px ${config.glow}, 0 8px 32px rgba(0,0,0,0.4)`
                  : "none",
